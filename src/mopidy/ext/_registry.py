...
class Registry(Mapping):
    ...
    Passed to the [setup][mopidy.ext.Extension.setup] method of all
    extensions. The registry can be used like a dict of string keys and lists.
    ...
    [ext_name][mopidy.ext.Extension.ext_name], e.g. `local:foo` or `http:bar`.
    """
