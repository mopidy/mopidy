...
Mopidy has very few [audio configurations](../reference/audio.md), but the ones we
...
`autoaudiosink`, you can set the [`audio/output`](../usage/config.md#audiooutput) config value to a
