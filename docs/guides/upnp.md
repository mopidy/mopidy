...
[UPnP](https://en.wikipedia.org/wiki/Universal_Plug_and_Play) is a set of
...
smartphones, TVs, Xbox, and PlayStation) that are often labeled as being
[DLNA](https://en.wikipedia.org/wiki/DLNA) compatible or certified.
...
[upmpdcli](https://www.lesbonscomptes.com/upmpdcli/) is recommended, since it
is easier to setup, and offers [OpenHome](http://wiki.openhome.org/wiki/OhMedia)
...
2. The default settings of upmpdcli will work with the default settings of
   mopidy-mpd. Edit `/etc/upmpdcli.conf` if you want to use different
...
See the [mopidy-mpris](https://github.com/mopidy/mopidy-mpris) documentation
...
[List of UPnP AV media servers and clients](https://en.wikipedia.org/wiki/List_of_UPnP_AV_media_servers_and_clients).
